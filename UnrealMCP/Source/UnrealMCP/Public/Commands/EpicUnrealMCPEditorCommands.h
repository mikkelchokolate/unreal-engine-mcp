...
private:
    ...
    TSharedPtr<FJsonObject> HandleCreateIKRetargeterAssets(const TSharedPtr<FJsonObject>& Params);
    TSharedPtr<FJsonObject> HandleEnsureAnimationSkeletons(const TSharedPtr<FJsonObject>& Params);
